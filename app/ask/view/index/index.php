			...
			<div class="spm">
				<ul class="postlist" id="divMain">
					...
					<li>
						...
						<p><span>时间：{$vo.post_create_times|diyDate}</span><span>阅读：{$vo.post_view}</span><span class="iconfont">&#xe610;&nbsp;{$vo.post_comment}条回答</span>{if condition="count($vo.post_tags)"}<span>
